...
use adxl345_driver2::{Adxl345Reader as _, Adxl345Writer};
...
async fn main(_spawner: Spawner) {
    ...
    adxl.set_bandwidth_rate(0b000_01011).unwrap();
    adxl.set_data_format(0b0000_1011).unwrap();
    adxl.set_power_control(0b0000_1011).unwrap();
    let sensitivity = 9.81/ 256.0;
    ...
    loop {
        ...
        info!("acc_x: {}, acc_y: {}, acc_z: {}", 
            (acc_x as f32) * sensitivity, 
            (acc_y as f32) * sensitivity,
            (acc_z as f32) * sensitivity
        );
    }
}
